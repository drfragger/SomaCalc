from wf_class_defs import Weapon
...
special_rifles = {'ARGONAK': ARGONAK, 'HIND': HIND, 'STRADAVAR': STRADAVAR, 'TENORA': TENORA, 'TIBERON_PRIME': TIBERON_PRIME, 'ZENITH': ZENITH}
...
FERROX = (Weapon('FERROX', 35, 245, 70, critC=0.32, critX=2.8,
                 magazine=10, reload_=2, firerate=1.33, chargetime=0.5),
          Weapon('FERROX_THROWN', 455, 72.5, 122.5, critC=0.04, critX=2,
                 magazine=1, reload_=2, firerate=1, chargetime=0.5))

JAVLOK = (Weapon('JAVLOK', ht=230, critC=0.2, critX=2,
                 magazine=6, reload_=1.9, firerate=3.33, chargetime=0.3),
          Weapon('JAVLOK_THROWN', 45, 75, 30, critC=0.2, critX=2,
                 magazine=1, reload_=0.6, firerate=1, chargetime=0.5))

SCOURGE = (Weapon('SCOURGE', crsv=70, critC=0.02, critX=1.5,
                  magazine=20, reload_=2.5, firerate=2.67),
...
ATTICA = Weapon('ATTICA', 4, 60, 16, critC=0.25, critX=3,
                magazine=20, reload_=2.8, firerate=3.67)

CERNOS = Weapon('CERNOS', 198, 11, 11, critC=0.36, critX=2,
                magazine=1, reload_=0.6, firerate=0, chargetime=0.5)
CERNOS_PRIME = Weapon('CERNOS_PRIME', 108, 6, 6, critC=0.35, critX=2,
                      magazine=1, reload_=0.65, firerate=0, chargetime=0.5, bullets=3)
